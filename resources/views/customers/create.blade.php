        ...
        <div class="row">
            <div class="col-xl-8 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('customer.save') }}" autocomplete="off">
                            @csrf
                            @method('post')
                                ...
                                <div class="form-group{{ $errors->has('status') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-document">{{ __('Status') }}</label>
                                        <div class="custom-control custom-radio mb-3">
                                            <input name="status" class="custom-control-input" id="status-new" checked="checked" type="radio" value="new">
                                            <label class="custom-control-label" for="status-new">New</label>
                                        </div>
                                        <div class="custom-control custom-radio mb-3">
                                            <input name="status" class="custom-control-input" id="status-active" type="radio" value="active">
                                            <label class="custom-control-label" for="status-active">Active</label>
                                        </div>
                                        <div class="custom-control custom-radio mb-3">
                                            <input name="status" class="custom-control-input" id="status-suspended" type="radio" value="suspended">
                                            <label class="custom-control-label" for="status-suspended">Suspended</label>
                                        </div>
                                        <div class="custom-control custom-radio mb-3">
                                            <input name="status" class="custom-control-input" id="status-cancelled" type="radio" value="cancelled">
